import { version, unref, inject, defineComponent, computed, watch, h, provide, shallowReactive, ref, Suspense, nextTick, Fragment, Transition, useSSRContext, hasInjectionContext, getCurrentInstance, createApp, effectScope, reactive, getCurrentScope, markRaw, isRef, isReactive, toRef, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, onScopeDispose, defineAsyncComponent, mergeProps, shallowRef, isReadonly, toRefs, isShallow } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/ofetch/dist/node.mjs';
...
import { getContext } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/ufo/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/vue-devtools-stub/dist/index.mjs';
...
import updateLocale from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/dayjs/plugin/updateLocale.js';
import relativeTime from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/dayjs/plugin/relativeTime.js';
import utc from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/dayjs/plugin/utc.js';
import { createPersistedState } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/pinia-plugin-persistedstate/dist/index.js';
import { parse as parse$1 } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/cookie-es/dist/index.mjs';
import { isEqual } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/ohash/dist/index.mjs';
import { parse, icon, config, text, library } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/@fortawesome/fontawesome-svg-core/index.mjs';
import { fas, far } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/@awesome.me/kit-c53b93d6fb/icons/modules/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///home/kae/Desktop/TempestBoard/front/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "issues-id",
    path: "/issues/:id()",
    component: () => import('./_id_-BrEdJqP-.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-5bTHpCH0.mjs')
  },
  {
    name: "myIssue",
    path: "/myIssue",
    component: () => import('./myIssue-B5iMwINp.mjs')
  },
  {
    name: "project",
    path: "/project",
    component: () => import('./project-Au4NDh2E.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-CvZKKbMe.mjs')
  },
  {
    name: "My Issue",
    path: "/",
...
This will fail in production.`);
    ...
    if (hot) {
      ...
      const newStore = isSetupStore ? createSetupStore(hotId, setup4, options, pinia, true) : createOptionsStore(hotId, assign({}, options), pinia, true);
...
library.add(fas, far);
const fontawesone_6SBstNjAmp = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DPCMhk6n.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BqCDHdiL.mjs'));
...
export { FontAwesomeIcon as F, asyncDataDefaults as a, useRequestFetch as b, createError as c, defineStore as d, entry$1 as default, useRouter as e, fetchDefaults as f, navigateTo as g, useRuntimeConfig as h, injectHead as i, resolveUnrefHeadInput as j, nuxtLinkDefaults as n, resolveRouteObject as r, useNuxtApp as u };

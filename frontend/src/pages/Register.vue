...
<template>
	<div id="register">
		<form class="register" @submit.prevent="handleRegister">
			...
			<input id="username" v-model="payload.username" minlength="3" name="username" placeholder="Username.." required
						 type="text" />
			<input id="email" v-model="payload.email" name="email" placeholder="Email.." required type="email" />
			<input id="password" v-model="payload.password" name="password" placeholder="Password.." required
						 type="password" />
			<input id="confirm_password" v-model="payload.confirm_password" name="confirm_password"

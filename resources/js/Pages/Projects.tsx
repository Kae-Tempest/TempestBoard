...
import { CreateProjectModal, DeleteProjectModal } from "@/Componants/Modals/ProjectModal";
                                        ...
                                        <div className="content-footer">
                                            <div className="btn-action">
                                                <button className="del" onClick={() => handleOpenDeleteModal(project)}>
                                                    <FontAwesomeIcon icon={faTrashCan} /> {/*Open Delete Confirm Modal*/}
                                                </button>
                                                <button className="edit" onClick={() => setOpenEditModal(true)}>
                                                    <FontAwesomeIcon icon={faPen} /> {/*Open Edit Modal*/}
                                                </button>
                                            </div>
                                            <div className="date">
